<?php
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO tedsters (name,email,mobile,committee,location) values(?, ?, ?, ?, ?)";
            $q = $pdo->prepare($sql);
            $q->execute(array($name,$email,$mobile,$committee,$location));
            Database::disconnect();
            header("Location: tedsters.php");
        }
    }
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    <div class="row">
                        <h3>Create a Tedster</h3>
                    </div>
             
                    <form class="form-horizontal" action="tedcreate.php" method="post">
